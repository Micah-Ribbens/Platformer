...
PLAYER_TIME_TO_JUMP_VERTEX = .3
PLAYER_RUNNING_DECELERATION_TIME = .3
PLAYER_INVINCIBILITY_TOTAL_TIME = 1
PLAYER_TIME_TO_GET_MAX_VELOCITY = .2
PLAYER_MAX_HORIZONTAL_VELOCITY = VelocityCalculator.get_velocity(SCREEN_LENGTH, 350)
...
### Probabilities
PROBABILITY_OF_GETTING_POWERUP_GENERATED = Fraction(1, 5)
...
AMMO_GAINED_FROM_KILLING_ENEMY = 3
...
### Straight Enemy
STRAIGHT_ENEMY_ACTION_PATH_WAIT_TIME = 1.6
STRAIGHT_ENEMY_HORIZONTAL_VELOCITY = VelocityCalculator.get_velocity(SCREEN_LENGTH, 800)
