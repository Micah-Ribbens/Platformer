...
from base.platformer_constants import TIME_BEFORE_WALL_OF_DEATH_STARTS_MOVING, TIME_GAME_HAS_RUN_TO_WALL_OF_DEATH_VELOCITY
...
class WallOfDeath(Component, GameObject):
    ...
    def __init__(self):
        ...
        super().__init__("images/wall_of_death.png")
